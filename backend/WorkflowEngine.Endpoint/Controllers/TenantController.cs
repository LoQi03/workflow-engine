...
public class TenantController(ITenantService tenantService) : ControllerBase
{
    ...
    public async Task<ActionResult<TenantDto>> GetById([FromRoute] int id)
    {
    ...
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    public async Task<ActionResult<TenantDto>> Update([FromRoute] int id, [FromBody] TenantDto dto)
    {
